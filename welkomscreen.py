...
FirstPage.configure(background = 'lightblue')
...
gh_inloggenFrame.configure(background = 'lightblue')
...
regOfLog.configure(background='lightblue')
...
regFrame.configure(background = 'lightblue')
...
bezoekersFrame.configure(background = 'lightblue')
...
FirstPage.pack(fill = 'both', expand = TRUE)
